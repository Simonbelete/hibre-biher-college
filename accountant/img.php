        ...
        if($result = mysqli_query($link, $sql)){
            if(mysqli_num_rows($result) ==1){
                ...
                <div class="profile-usertitle">
                    <div class="profile-usertitle-name"><b>Name : <?php echo $row['First_Name']." ".$row['Last_Name']; ?></b></div>
                    <div class="profile-usertitle-name"><b>User Role : <?php echo $row['Role']; ?></b></div>
