                                ...
                                if(mysqli_num_rows($result) > 0){
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                           <a href="delete.php?delId=<?php echo $row['Date'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this user?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
                                        </td>
                                    </tr><?php
