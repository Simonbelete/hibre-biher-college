                                                ...
                                                <div  class="row">
                                                    <div class="col-md-6">
                                                      <div class="form-group">
                                                        ...
                                                        <input type="text"name="Grand_Father_Name" required="required"  value="<?php echo $row['Gender']; ?>" class="form-control" id="inputgrandfathername" placeholder="Email">
                                                      </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                      <div class="form-group">
                                                        <label for="exampleInputPassword1">Phone Number</label>
                                                        <input type="text"name="gender" required="required" value="<?php echo $row['Phone']; ?>"  class="form-control" id="exampleInputPassword1" placeholder="Password">
                                                      </div>
                                                    </div>
                                                </div>
                                                <div  class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                      <div class="form-group">
                                                        ...
                                                        <input type="number"name="Phone"   required="required" value="<?php echo $row['Field_of_study']; ?>" class="form-control" id="inputphone" placeholder="phone">
                                                      </div>
                                                    </div>
                                                </div>
                                                <div  class="row">
                                                    <div class="col-md-6">
                                                      <div class="form-group">
                                                        ...
                                                        <input type="text"name="Region"   required="required" value="<?php echo $row['Role']; ?>"  class="form-control" id="inputRegion" placeholder="Region">
                                                      </div>
                                                    </div>
                                                </div>
                                              </div>
