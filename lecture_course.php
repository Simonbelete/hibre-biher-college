...
<body>
    ...
    <div class="wrapper">
       ...
       <div id="content">
            ...
            <?php require_once('lecture/lecture_course.php'); ?>
            <iframe src="windows/column_search_lecture_cource/index.php" style="margin-left: -10px; padding-left: -10px; width: 100%" frameborder="10"  width="100%" height="48%"></iframe>
       </div>
    </div>
