    ...
    if( isset($_SESSION['username'])&& isset($_SESSION['role'])){
        ...
        <body>
            <?php  require_once('AddDept.php');?>
            <?php  require_once('AddCourse.php');?>
            <?php  require_once('adduser.php');?>   
            <?php    require_once('addstudentmodal.php');?>
            <?php    require_once('addimagemodal.php'); ?>
            <div class="wrapper">
               <?php require_once('left.php'); ?>
               <div id="content">
                  <?php require_once('adminheader.php'); ?><br>
                  <iframe src="NoticeBoard.php" frameborder="12" width="100%" height="90%"></iframe>
               </div>
            </div>
